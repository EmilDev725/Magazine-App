...
class DSaved: UIViewController, MFMailComposeViewControllerDelegate {

    @IBOutlet weak var const_topbar_height: NSLayoutConstraint!
    
    @IBOutlet weak var img_magazine: UIImageView!
    
    var img_cover : UIImage?
    
    override func viewDidLoad() {
        super.viewDidLoad()

        img_magazine.image = img_cover
    }
